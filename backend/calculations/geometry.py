...
def distance_to(obs_latitude: float, obs_longitude: float, end_latitude: float, end_longitude: float) -> float:
    ...
    radicand = sin((end_latitude - obs_latitude)/2.0)**2 + cos(obs_latitude)*cos(end_latitude)*sin((end_longitude - obs_longitude)/2.0)**2
